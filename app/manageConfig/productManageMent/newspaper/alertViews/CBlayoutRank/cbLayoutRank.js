...
*/
"use strict";
angular.module("productManageMentCBLayoutRankModule", [])
    .controller("productManageMentCBLayoutRankCtrl", ["$scope", "$timeout", "$q", "$modalInstance", "$stateParams", "trsHttpService", "trsspliceString", "title", "initSingleSelecet", function($scope, $timeout, $q, $modalInstance, $stateParams, trsHttpService, trsspliceString, title, initSingleSelecet) {
        initStatus();
        initData();
