...
angular.module("productManageMentAppColumnRecycleBinModule", [])
    .controller("productManageMentAppColumnRecycleBinCtrl", ["$scope", "$q", "$stateParams", "$state", "trsHttpService", "productMangageMentWebsiteService", "trsconfirm", "localStorageService", function($scope, $q, $stateParams, $state, trsHttpService, productMangageMentWebsiteService, trsconfirm, localStorageService) {
        initStatus();
        initData();
        //获取栏目操作权限开始
