...
angular.module("productManageMentAppColumnModule", [
    ...
    .controller("productManageMentAppColumnCtrl", ['$scope', '$rootScope', '$q', '$state', '$modal', '$stateParams', 'trsHttpService', "websiteService", "trsconfirm", "productMangageMentWebsiteService", "localStorageService", function($scope, $rootScope, $q, $state, $modal, $stateParams, trsHttpService, websiteService, trsconfirm, productMangageMentWebsiteService, localStorageService) {
        initStatus();
        initData();
        /**
