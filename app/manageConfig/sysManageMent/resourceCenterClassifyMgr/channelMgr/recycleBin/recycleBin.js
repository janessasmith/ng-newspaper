 ...
 */
angular.module("manConSysSouCenSiteChnnlRecycleModule",[])
    .controller("manConSysSouCenSiteChnnlRecycleCtrl",["$scope","manConSysSouCenClassifyMgrService",'trsHttpService','trsconfirm',function($scope,manConSysSouCenClassifyMgrService,trsHttpService,trsconfirm){
        initStatus();
        function initStatus(){
            $scope.selectedSite = {
                SITENAME:"假的试一试"
