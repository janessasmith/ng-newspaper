 ...
 *  logManageMentModule
 *
 * Description  管理配置 日志管理 接口日志
 * rebuild:SMG 2016-4-20
 */
"use strict";
angular.module('logManageMentInterfaceLogModule', [
        'logManageMentInterfaceLogRouterModule'
    ])
    .controller('logManageMentInterfaceLogCtrl', ['$scope', 'trsHttpService', 'initComDataService', 'dateFilter', "trsconfirm",
