 ...
 *  logManageMentModule
 *
 * Description  管理配置 日志管理 系统日志 性能诊断
 * rebuild:SMG 2016-4-20
 */
"use strict";
angular.module('systemlogPerformanceTestModule', [])
    .controller('systemlogPerformanceTestCtrl', ['$scope', 'trsHttpService', 'initComDataService', 'dateFilter', "trsconfirm",
