angular.module('resCenAppModule', ['resCtrModalModule'])
    .controller('resCenAppMainCtrl', ['$scope', '$q', '$interval', '$state', '$location', '$modal', 'resCtrModalService', 'initComDataService', 'resourceCenterService', 'trsspliceString', 'trsconfirm', 'leftService', 'dateFilter', 'globleParamsSet', 'trsHttpService', '$timeout', 'trsPrintService', 'storageListenerService',
