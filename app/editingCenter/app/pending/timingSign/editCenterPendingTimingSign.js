'use strict';
angular.module('editingCenterPendingTimingSignModule', [])
    .controller('editPendingTimingSignController', ['$scope', "$modal", "trsHttpService", "$stateParams", "trsconfirm", "trsspliceString", "$timeout", "initSingleSelecet", "globleParamsSet", "storageListenerService", "editingCenterService",
        function($scope, $modal, trsHttpService, $stateParams, trsconfirm, trsspliceString, $timeout, initSingleSelecet, globleParamsSet, storageListenerService, editingCenterService) {
            initStatus();
            initData();
            /**
            ...
            function initDropDown() {
                $scope.data.docTypeJsons = initSingleSelecet.docType();
