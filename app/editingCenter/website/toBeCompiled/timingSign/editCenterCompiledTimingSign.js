'use strict';
/**
    created by cc 2016-03-01
 */
angular.module('editingCenterCompiledWebsiteTimingSignModule', [])
    .controller('editCompileWebsiteTimingSignController', ['$scope', '$q', "trsHttpService", "$stateParams", '$modal', 'trsconfirm', 'trsspliceString', 'SweetAlert', '$timeout', 'initSingleSelecet', 'initVersionService', 'editcenterRightsService', "getWebsiteNameService", "editingCenterService", "globleParamsSet", function($scope, $q, trsHttpService, $stateParams, $modal, trsconfirm, trsspliceString, SweetAlert, $timeout, initSingleSelecet, initVersionService, editcenterRightsService, getWebsiteNameService, editingCenterService, globleParamsSet) {
        initStatus();
        initData();
        //初始化状态
        function initStatus() {
        ...
        $scope.queryByDropdown = function(type, value) {
            ...
            $scope.status.copyCurrPage = $scope.page.CURRPAGE = $scope.params.CurrPage = 1;
            if (type == 'timeType') {
                if (value.length < 10) {
