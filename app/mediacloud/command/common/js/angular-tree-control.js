                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
                    ...
                    if(!template) {
                        template =
                            ...
                            '<div class="tree-label {{options.labelClass}}" ng-class="iBranchClass()" ng-click="selectNodeHead(node)" ng-class="[selectedClass(), unselectableClass()]" ng-click="selectNodeLabel(node)" tree-transclude></div>' +
