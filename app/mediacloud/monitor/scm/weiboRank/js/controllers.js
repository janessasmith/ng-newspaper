 ...
 */
app.controller('wbNavigationCtrl', function($scope,utilUnit,utilClass) {
 ...
 * @return {[type]}              [description]
 */
app.controller('weiboRankListCtrl',  function($scope,$stateParams,weiboRankListSer,$filter){
	...
	$scope.getcontent = function() {
		...
		var weiboRankList = weiboRankListSer.queryWeiboRankList($scope.params);

		weiboRankList.then(function(data) {
