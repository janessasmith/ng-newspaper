 ...
 * @param  {[type]} $filter)     {	$scope.accountType [description]
 * @return {[type]}              [description]
 */
app.controller('weixinNewlistCtrl', function($rootScope, $scope, $stateParams,$filter,weixinnewlistSer) {
	...
	//搜索条件
	$scope.getWeixinnewlist = function() {
		...
		var searchList = weixinnewlistSer.queryWeixinnewlist(params);
